...
public class MakeAnOffer {
	...
	public void navigateToWatchDetails() throws InterruptedException {
		WebElement cookieButton = wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='affirm consent-btn close-button']")));
		cookieButton.click();

		WebElement brandMenu = driver
				.findElement(By.xpath("//div[@class='menu-group']//li[@id='shop']//a[text()='BRANDS']"));
		...
		WebElement watchFamily = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@title='GMT-Master II']")));
		watchFamily.click();
		...
		WebElement watch = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"//img[@src=\"https://watchbox-cdn.imgix.net/posted-product-images/637659148830727872.jpg?w=1184&h=1184\"]")));
		watch.click();

		/*
		 * Boolean isText=driver.findElement(By.
		 * xpath("//div[text()='Continue to the United States site']")).isDisplayed();
		 * if(isText==true) { driver.findElement(By.
		 * xpath("//div[text()='Continue to the United States site']")).click(); }
		 */

		implicitWait();
		WebElement mknofferButton = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='make-an-offers']")));
	...
	public void submitOffer() throws Exception {
		...
		WebElement submitButton = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//button[@id='submit_btn_makeAnOffer' and @name='submit']")));
		submitButton.click();
	...
	public void verifyAccount() throws Exception {
		WebElement searchBox = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"//button[@class='slds-button slds-button_neutral search-button slds-truncate' and @type='button']")));
		searchBox.click();

		implicitWait();
		Thread.sleep(10000);

		WebElement searchString = wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//input[@type='search' and @class='slds-input']")));
		searchString.sendKeys(emailId);
		searchString.sendKeys(Keys.ENTER);

		Thread.sleep(8000);
		WebElement accTable = driver.findElement(By.xpath(
				"//div[@class='resultsItem slds-col slds-no-flex slds-m-bottom_small'][2]//table[@role='grid']"));

		// Account verification
		WebElement accTableRow = accTable.findElement(By.xpath(
				"//div[@class='resultsItem slds-col slds-no-flex slds-m-bottom_small'][2]//table[@role='grid']/tbody/tr/th/span/a"));
		String accRowText = accTableRow.getText();
		System.out.println("Account Created: " + accRowText);

		// Deal verification
		WebElement dealTable = driver.findElement(By.xpath(
				"//div[@class='resultsItem slds-col slds-no-flex slds-m-bottom_small'][1]//table[@role='grid']"));
		WebElement dealTableRow = dealTable.findElement(By.xpath(
				"//div[@class='resultsItem slds-col slds-no-flex slds-m-bottom_small'][1]//table[@role='grid']/tbody/tr/th/span/a"));
		...
		WebElement accEmail = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='emailuiFormattedEmail']")));
		String accEmailText = accEmail.getText();
		System.out.println("Email: " + accEmailText);

		WebElement accPhoneNumber = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[text()='+91 5552221245']")));
	...
	public void verifyDeal() throws InterruptedException {
		...
		driver.findElement(
				By.xpath("//a[@class='slds-card__header-link baseCard__header-title-container']/span[@title='Deals']"))
				.click();
		...
		System.out.println("Deal Name: " + driver
				.findElement(By.xpath("//lightning-formatted-name[@data-output-element-id='output-field']")).getText());
		System.out.println("Account Name: " + driver.findElement(By.xpath(
				"//*[@id='brandBand_2']//div/p[@title='Account Name']/parent::div/p[2]/slot/force-lookup/div/force-hoverable-link/div/a/slot/slot/span"))
				.getText());
		System.out.println("Customer Email: "
				+ driver.findElement(By.xpath("//*[@id='brandBand_2']//div/p[@title='Customer Email']/parent::div//a"))
						.getText());
		System.out.println("Customer Phone: " + driver
				.findElement(By.xpath(
						"//*[@id='brandBand_2']//div/p[@title='Customer Phone']/parent::div//lightning-formatted-text"))
				.getText());
		System.out.println("Deal Type: " + driver
				.findElement(By.xpath(
						"//*[@id='brandBand_2']//div/p[@title='Deal Type']/parent::div//lightning-formatted-text"))
				.getText());
		// System.out.println("Marketing Source:
		// "+driver.findElement(By.xpath("//*[@id='window']")).getText());
		System.out.println(
				"Deal " + driver.findElement(By.xpath("//flexipage-component2[1]//a[@title='Sales'][1]")).getText());
